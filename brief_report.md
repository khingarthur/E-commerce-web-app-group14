...
- **Conditional navigation requirements**
...
- **Balancing UX simplicity with functionality**
  The project required simple interfaces while still showing meaningful checkout details. The final approach used lightweight in-page feedback instead of a complex modal flow.



Overall, ShopEase now supports a complete basic shopping journey—browse, add to cart, manage quantities, and checkout—with session-based authentication and improved UI consistency.
